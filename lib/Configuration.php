...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.deeparteffects.com/v1';
    ...
    {
        $report  = 'PHP SDK (Deeparteffects\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2017-02-10T16:24:46Z' . PHP_EOL;
