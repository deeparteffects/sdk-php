...
class ApiClient
{
     ...
     */
    public function __construct(\Deeparteffects\Client\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Deeparteffects\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null, $region='eu-west-1', $access_key = null, $secret_key = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Deeparteffects\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
        ...
        if($access_key != null & $secret_key != null) {
            $sign = new SignatureV4('execute-api', $region);
